...
var CreateCategoryInMemory_1 = require("../../Repositories/In-memory/CreateCategoryInMemory");
...
describe("Create a Category", function () {
    beforeEach(function () {
        categoriesRepositoryInMemory = new CreateCategoryInMemory_1.CategoriesRepositoryInMemory();
    ...
    it("Should not be able to create a category that already exists", function () { return __awaiter(void 0, void 0, void 0, function () {
        var category;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
